...
本機打包前置：.NET 10 SDK、[Inno Setup 6 或 7](https://jrsoftware.org/isinfo.php)、已登入的 GitHub CLI。要簽署時另需 .NET 8 Runtime、`az login` 與 `installer/windows/trusted-signing.json`。
