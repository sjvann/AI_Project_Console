...
**規劃**（公司工作區：客戶生命週期、成立專案、甘特、階段投入、需求分析目錄）。**現況**已有：工作區／倉、需求工作台開 Issue 與驗收。不要在工作區重做進件表或 DocFX 編輯器。仲介成交前的需求精靈見 [仲介平台](../marketplace.md)。本模組可獨立建客戶與專案；仲介成交時可投影一條，不必先走仲介。
