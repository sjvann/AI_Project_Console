...
全域導覽（權限內才出現）：戰情室、專案、客戶、派工、人員、外包商、預算、薪資、帳戶、設定。設定內含：公司、主題、匯率。人員帳戶在「帳戶」。工程師只見「我的工時／薪資條」與說明「繪圖請用控制台」。
...
上：分頁「薪資週期｜待 PM 確認」。週期用頁籤一次只展開一張表。加班金額、鎖定原因在對話框，必填原因。不要把所有歷史週期的表疊成一條捲軸。
